...
load_configuration() {
    ...
    CACHE_Credentials=$(jetpack config cyclecloud.ldap_auth.cache_credentials false)
    ...
    TLS_reqcert=$(jetpack config cyclecloud.ldap_auth.tls_req_cert allow)
    ID_mapping=$(jetpack config cyclecloud.ldap_auth.id_mapping true)
